...
namespace WebGLSupport
{
    ...
    public static class WebGLWindow
    {
        ...
        public static event Action OnForceBlurAndroidEvent = () => { };
        
        public static event Action OnForceBlurIOSEvent = () => { };
        public static event Action<bool> OnResizeEvent = (status) => { };
        ...
        public static void ForceBlur(bool isAndroid)
        {
            if (isAndroid)
                OnForceBlurAndroidEvent();
            else
                OnForceBlurIOSEvent();
        }
        ...
        public static void ForceResize()
        {
            IsResizing = !IsResizing;
            OnResizeEvent(IsResizing);
        }
