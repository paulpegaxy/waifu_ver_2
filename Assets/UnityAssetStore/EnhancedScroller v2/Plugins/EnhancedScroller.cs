...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public bool IsUseContentSizeFilter;

        public bool IsNotUseForceChildHeight;
        ...
        void Awake()
        {
            ...
            _layoutGroup.childForceExpandHeight = !IsNotUseForceChildHeight;
            _layoutGroup.childControlHeight = !IsNotUseForceChildHeight;
