...
namespace FancyScrollView
{
    ...
    {
        public UnityEvent onScrollerPointerDown = new UnityEvent();
        public UnityEvent onScrollerPointerUp = new UnityEvent();
        public UnityEvent onScrollerDragging = new UnityEvent();
        public UnityEvent onScrollerEndDragging = new UnityEvent();
        ...
        public void OnValueChanged(UnityAction<float> callback) => onValueChanged.AddListener(callback);

        /// <summary>
        /// 選択位置が変化したときのコールバックを設定します.
        /// </summary>
        /// <param name="callback">選択位置が変化したときのコールバック.</param>
        public void OnSelectionChanged(UnityAction<int> callback) => onSelectionChanged.AddListener(callback);
