...
namespace Doozy.Editor.UIManager.Editors.Containers
{
    ...
    public class UIPopupEditor : BaseUIContainerEditor
    {
        ...
        protected SerializedProperty propertyDestroyOnHide { get; set; }
        ...
        protected override void FindProperties()
        {
            ...
            propertyDestroyOnHide = serializedObject.FindProperty(nameof(UIPopup.DestroyOnHide));
        ...
        protected override void InitializeSettings()
        {
            ...
            settingsAnimatedContainer.SetOnShowCallback(() =>
            {
                ...
                FluidToggleSwitch destroyOnHideToggleSwitch =
                    FluidToggleSwitch.Get("Destroy On Hide")
                        .SetToggleAccentColor(selectableAccentColor)
                        .BindToProperty(propertyDestroyOnHide)
                        .SetTooltip("Destroy popup after hide");
                ...
                FluidField hideOptionsFluidField =
                    FluidField.Get("Hide this popup via")
                        ...
                        (
                            DesignUtils.row
                                .AddChild(destroyOnHideToggleSwitch)
                                .AddSpaceBlock()
