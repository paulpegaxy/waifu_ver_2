...
namespace Doozy.Runtime.UIManager.Containers
{
    ...
    public partial class UIPopup : UIContainerComponent<UIPopup>
    {
        ...
        /// <summary> Don't destroy game object after hide </summary>
        ...
        protected override void Awake()
        {
            ...
            backButtonReceiver = new SignalReceiver().SetOnSignalCallback(signal =>
            {
                ...
                if (visiblePopups.LastOrDefault() != this) return;
                Hide();
            });
        }
        ...
        public override void Show()
        {
            ...
            SendSignal(ShowHideExecute.Show);
            base.Show();
        }
        ...
        public override void InstantShow()
        {
            ...
            AddOnClickToContainer();
            StartSortingCoroutine();
            SendSignal(ShowHideExecute.InstantShow);
            base.InstantShow();
        }
        ...
        public override void Hide()
        {
            StopSortingCoroutine();
            // EnableBackButton();
            SendSignal(ShowHideExecute.Hide);
            base.Hide();
        }
        ...
        public override void InstantHide()
        {
            StopSortingCoroutine();
            // EnableBackButton();
            SendSignal(ShowHideExecute.InstantHide);
            base.InstantHide();
        }
        ...
        private void SendSignal(ShowHideExecute showHideExecute)
        {
            Signal.Send(nameof(UIContainer), nameof(UIPopup), new UIPopupSignalData(name.Replace("(Clone)", ""), showHideExecute));
        }
